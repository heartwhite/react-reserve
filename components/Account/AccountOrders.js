          ...
          <>
            ...
            <List>
              {order.products.map(p => (
                <List.Item key={p._id}>
                  <Image avatar src={p.product ? p.product.mediaUrl : ''} />
                  <List.Content>
                    <List.Header>{p.product ? p.product.name : 'item deleted'}</List.Header>
                    <List.Description>
                      {p.quantity && p.quantity} · ${p.product && p.product.price}
                    </List.Description>
                  </List.Content>
